...
class ConfigHttp:
    ...
    def get(self):
        ...
        try:                                #request库发送一次get请求
            response = self.seesion.get(self.url, headers=self.headers, timeout=float(timeout), cookies=self.cookies)
    ...
    def getjson(self):
        ...
        """
        try:  # request库发送一次get请求
            response = self.seesion.get(self.url, headers=self.headers, json=self.data,timeout=float(timeout), cookies=self.cookies)
            # response.raise_for_status()
            return response
        except TimeoutError:  # 超时抛出异常
            self.logger.error("Time out!")
    ...
    def post(self):
        ...
        try:                                #request库发送一次post请求
            response = self.seesion.post(self.url,headers=self.headers,data=self.data, timeout=float(timeout), cookies=self.cookies)
    ...
    def postWithFile(self):
        ...
        """
        try:
            response = self.seesion.post(self.url, headers=self.headers, data=self.data, files=self.files, timeout=float(timeout), cookies=self.cookies)
            return response
        except TimeoutError:
            self.logger.error("Time out!")
            return None
    ...
    def postWithJson(self):
        ...
        """
        try:
            response = self.seesion.post(self.url, headers=self.headers, json=self.data,timeout=float(timeout), cookies=self.cookies)
            return response
        except TimeoutError:
            self.logger.error("Time out!")
            return None
    ...
    def putWithJson(self):
        ...
        """
        try:
            response = self.seesion.put(self.url, headers=self.headers, json=self.data, timeout=float(timeout), cookies=self.cookies)
            return response
        except TimeoutError:
            self.logger.error("Time out!")
            return None
    ...
    def postWithJsondata(self,data):
        ...
        """
        try:
            response = requests.post(self.url, headers=self.headers, json=data,timeout=float(timeout), cookies=self.cookies)
            return response
        except TimeoutError:
            self.logger.error("Time out!")
            return None
    ...
    def postWithJsondataurl(self,url,data):
        ...
        """
        try:
            response = self.seesion.post(url, headers=self.headers, json=data, timeout=float(timeout), cookies=self.cookies)
            return response
        except TimeoutError:
            self.logger.error("Time out!")
            return None
    ...
    def postredirects(self):
        ...
        """
        try:
            response = self.seesion.post(self.url,headers=self.headers,data=self.data, timeout=float(timeout),allow_redirects=False, cookies=self.cookies)
            return response
        except TimeoutError:
            self.logger.error("Time out!")
            return None
